                                    ...
                                    while ($row = mysqli_fetch_array($results)) : ?>
                                        <tr>
                                            ...
                                            <?php if ($row['status']=='Died') {?>
                                                <button type="button" class="edt" hidden><a href="pnt.php?edit=<?php echo $row['id']; ?>" style="color:#000; text-decoration:none;">Edit</a></button>
                                             <?php }else{?><button type="button" class="edt"><a href="pnt.php?edit=<?php echo $row['id']; ?>" style="color:#000; text-decoration:none;">Edit</a></button></td><?php } ?>
