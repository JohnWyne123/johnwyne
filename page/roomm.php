            ...
            <div class="input-group">
                ...
                <div style="color:red;"><?php
                        if (isset($_GET['invalid'])) { ?>
                            <p class="invalid"><?php echo $_GET["invalid"]; ?></p>
                        <?php }?></div>
                <input placeholder="Capacity" maxlength="2" type="number" name="capacity" onkeyup="val(this)" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" value="<?php echo $capacity;?>" required="required">
